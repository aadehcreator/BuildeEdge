...
async function main() {
  ...
  const subCategories = await Promise.all([
    ...
    prisma.category.upsert({ where: { slug: 'tiles' }, update: {}, create: { name: 'Tiles', slug: 'tiles', image: 'https://images.unsplash.com/photo-1599809275671-b5942cabc7a2?w=400', parentId: catCivil.id, sortOrder: 3 } }),
    ...
    prisma.category.upsert({ where: { slug: 'wires-cables' }, update: {}, create: { name: 'Wires & Cables', slug: 'wires-cables', image: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=400', parentId: catElectrical.id, sortOrder: 2 } }),
  ...
  const products = [
    ...
    },
    {
      ...
      categoryId: tiles.id,
      images: ['https://images.unsplash.com/photo-1599809275671-b5942cabc7a2?w=600'],
